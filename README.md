...
- Build date: 2026-08-11T03:57:45.818377379Z[Etc/UTC]
...
```shell
gem install ./digital_femsa-1.1.2.gem
```

(for development, run `gem install --dev ./digital_femsa-1.1.2.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'digital_femsa', '~> 1.1.2'
