...
module DigitalFemsa
  ...
  class CheckoutRequest
    ...
    # Number of seconds to wait before redirecting to the success or failure url
    ...
    def hash
      [allowed_payment_methods, expires_at, failure_url, name, on_demand_enabled, success_url, type, redirection_time].hash
    end
